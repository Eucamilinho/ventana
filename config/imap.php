    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            // 'host'  => env('IMAP_HOST', 'mail.sodeker.com'),
            // 'port'  => env('IMAP_PORT', 993),
            // 'protocol'  => env('IMAP_PROTOCOL', 'imap'), //might also use imap, [pop3 or nntp (untested)]
            // 'encryption'    => env('IMAP_ENCRYPTION', 'ssl'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            // 'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            // 'username' => env('IMAP_USERNAME', 'logistica@sodeker.com'),
            // 'password' => env('IMAP_PASSWORD', 'S0D@2016*_K3R'),
            ...
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME', 'monitor@teutronica.com'),
            'password' => env('IMAP_PASSWORD', '1224SmTp&&&'),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
