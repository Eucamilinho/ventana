...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                {{-- <img src="{{ URL::asset('build/images/logo-sm.png') }}" alt="" height="22"> --}}
                <img src="@if( Auth::user()->imgLogoEmpresa != ""){{Auth::user()->imgLogoEmpresa}} @else{{ URL::asset('storage/imagenes/WhatsApp_Im…023-04-03_at_8.18.58_AM-556435433_1680527960.jpeg')}} @endif" alt="" height="17">
            </span>
            <span class="logo-lg">

               {{-- ; --}}
                <img src="@if( Auth::user()->imgLogoEmpresa != ""){{Auth::user()->imgLogoEmpresa}} @else{{ URL::asset('storage/imagenes/WhatsApp_Im…023-04-03_at_8.18.58_AM-556435433_1680527960.jpeg')}} @endif" alt="" height="50">
                {{-- <img src="{{ URL::asset('storage/WhatsApp_Image_2023-04-03_at_8.18.58_AM-425188394_1680527973.jpg') }}" alt="" height="17"> --}}
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-apps-2-line"></i> <span>Básicos</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="basicos" class="nav-link">Básicos</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#usersApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="usersApps">
                        <i class="ri-account-circle-line"></i> <span>Usuarios</span>
                    </a>
                    <div class="collapse menu-dropdown" id="usersApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
